...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Leo", "PuppetSurvival", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Puppet Survival";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Puppet Survival", null, { width: 1024, height: 608 });
