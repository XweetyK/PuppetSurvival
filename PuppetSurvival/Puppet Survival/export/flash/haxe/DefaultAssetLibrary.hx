...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/MenuLVL.oel", __ASSET__assets_data_menulvl_oel);
		type.set ("assets/data/MenuLVL.oel", AssetType.TEXT);
		className.set ("assets/data/Newpiskel.png", __ASSET__assets_data_newpiskel_png);
		type.set ("assets/data/Newpiskel.png", AssetType.IMAGE);
		className.set ("assets/data/pLevel.oep", __ASSET__assets_data_plevel_oep);
		type.set ("assets/data/pLevel.oep", AssetType.TEXT);
		className.set ("assets/images/cris.png", __ASSET__assets_images_cris_png);
		type.set ("assets/images/cris.png", AssetType.IMAGE);
		className.set ("assets/images/crisfull.png", __ASSET__assets_images_crisfull_png);
		type.set ("assets/images/crisfull.png", AssetType.IMAGE);
		...
		className.set ("assets/images/marcoM.png", __ASSET__assets_images_marcom_png);
		type.set ("assets/images/marcoM.png", AssetType.IMAGE);
		...
		type.set ("assets/sounds/Hit_Hurt35.wav", AssetType.SOUND);
		className.set ("assets/sounds/Jump6.wav", __ASSET__assets_sounds_jump6_wav);
		type.set ("assets/sounds/Jump6.wav", AssetType.SOUND);
		className.set ("assets/sounds/Pickup_Coin36.wav", __ASSET__assets_sounds_pickup_coin36_wav);
		type.set ("assets/sounds/Pickup_Coin36.wav", AssetType.SOUND);
		className.set ("assets/sounds/Randomize6.wav", __ASSET__assets_sounds_randomize6_wav);
		type.set ("assets/sounds/Randomize6.wav", AssetType.SOUND);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/data/MenuLVL.oel";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/data/Newpiskel.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/data/pLevel.oep";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/images/cris.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/crisfull.png";
		path.set (id, id);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/sounds/Hit_Hurt35.wav";
		path.set (id, id);
		
		type.set (id, AssetType.SOUND);
		id = "assets/sounds/Jump6.wav";
		path.set (id, id);
		
		type.set (id, AssetType.SOUND);
		id = "assets/sounds/Pickup_Coin36.wav";
		path.set (id, id);
		
		type.set (id, AssetType.SOUND);
		id = "assets/sounds/Randomize6.wav";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_menulvl_oel extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_newpiskel_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_data_plevel_oep extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_cris_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_crisfull_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_marcom_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_sounds_hit_hurt35_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_jump6_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_pickup_coin36_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_randomize6_wav extends flash.media.Sound { }
...
@:file("assets/data/MenuLVL.oel") #if display private #end class __ASSET__assets_data_menulvl_oel extends lime.utils.Bytes {}
@:image("assets/data/Newpiskel.png") #if display private #end class __ASSET__assets_data_newpiskel_png extends lime.graphics.Image {}
@:file("assets/data/pLevel.oep") #if display private #end class __ASSET__assets_data_plevel_oep extends lime.utils.Bytes {}
@:image("assets/images/cris.png") #if display private #end class __ASSET__assets_images_cris_png extends lime.graphics.Image {}
@:image("assets/images/crisfull.png") #if display private #end class __ASSET__assets_images_crisfull_png extends lime.graphics.Image {}
...
@:image("assets/images/marcoM.png") #if display private #end class __ASSET__assets_images_marcom_png extends lime.graphics.Image {}
...
@:file("assets/sounds/Hit_Hurt35.wav") #if display private #end class __ASSET__assets_sounds_hit_hurt35_wav extends lime.utils.Bytes {}
@:file("assets/sounds/Jump6.wav") #if display private #end class __ASSET__assets_sounds_jump6_wav extends lime.utils.Bytes {}
@:file("assets/sounds/Pickup_Coin36.wav") #if display private #end class __ASSET__assets_sounds_pickup_coin36_wav extends lime.utils.Bytes {}
@:file("assets/sounds/Randomize6.wav") #if display private #end class __ASSET__assets_sounds_randomize6_wav extends lime.utils.Bytes {}
