...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/data/MenuLVL.oel");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/data/Newpiskel.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/data/pLevel.oep");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/images/cris.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/crisfull.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/marcoM.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/sounds/Hit_Hurt35.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/sounds/Jump6.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/sounds/Pickup_Coin36.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/sounds/Randomize6.wav");
		types.push (lime.Assets.AssetType.SOUND);
